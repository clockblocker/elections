...
- `2026-09-20/` stores the current official campaign/UIK/candidate-set snapshot for
  every federal, regional, and local campaign scheduled on that voting date. It keeps
  inactive candidates and uncertain association registration marks explicitly labeled.
